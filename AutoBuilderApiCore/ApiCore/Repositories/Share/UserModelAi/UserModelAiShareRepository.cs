    ...
    public class UserModelAiShareRepository : BaseShareRepository<UserModelAiRequestShareDto, UserModelAiResponseShareDto, UserModelAiRequestBuildDto, UserModelAiResponseBuildDto>, IUserModelAiShareRepository
    {
        ...
        public override async Task<UserModelAiResponseShareDto> CreateAsync(UserModelAiRequestShareDto entity)
        {
            try
            {
                ...
                var output = (UserModelAiResponseShareDto)result;
        ...
        /// </summary>
        public override Task<IEnumerable<UserModelAiResponseShareDto>> CreateRangeAsync(IEnumerable<UserModelAiRequestShareDto> entities)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult<IEnumerable<UserModelAiResponseShareDto>>(null);
            }
        }
        ...
        /// </summary>
        public override Task DeleteRangeAsync(Expression<Func<UserModelAiResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<bool> ExistsAsync(Expression<Func<UserModelAiResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<UserModelAiResponseShareDto?> FindAsync(Expression<Func<UserModelAiResponseShareDto, bool>> predicate)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult<UserModelAiResponseShareDto>(null);
            }
        }
        ...
        /// </summary>
        public override Task<IEnumerable<UserModelAiResponseShareDto>> GetAllAsync()
        {
            try
            {
        ...
        /// </summary>
        public override Task<UserModelAiResponseShareDto?> GetByIdAsync(string id)
        {
            try
            {
        ...
        /// </summary>
        public override Task<UserModelAiResponseShareDto> UpdateAsync(UserModelAiRequestShareDto entity)
        {
            try
            {
