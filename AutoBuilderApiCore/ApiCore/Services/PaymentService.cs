...
namespace Services.Services
{
    ...
    public  interface  IUsePaymentService :  IPaymentService < PaymentRequestDso ,  PaymentResponseDso > { 
    ///
     /////
    ...
    ///
     { 
    ///
     private  readonly  IPaymentShareRepository  _paymentShareRepository ;  
    ///
     public  PaymentService ( IPaymentShareRepository  paymentShareRepository ,  IMapper  mapper ,  ILoggerFactory  logger ) 
    ///
     :  base ( mapper ,  logger ) { 
    ///
     _paymentShareRepository  =  paymentShareRepository ;  
    ///
     } 
    ///
