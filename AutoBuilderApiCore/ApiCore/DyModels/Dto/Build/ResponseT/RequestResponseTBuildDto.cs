...
{
    public class RequestResponseTBuildDto : ITBuildDto
    {
        /// <summary>
        /// Id property for DTO.
        /// </summary>
        ...
        public SpaceResponseTBuildDto? Space { get; set; }
        public ICollection<EventRequestResponseTBuildDto>? Events { get; set; }
    }
}