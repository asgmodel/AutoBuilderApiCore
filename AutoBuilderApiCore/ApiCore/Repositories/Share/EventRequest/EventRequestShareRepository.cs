...
namespace ApiCore.Repositorys.Share
{
    ...
    public class EventRequestShareRepository : BaseShareRepository<EventRequestRequestShareDto, EventRequestResponseShareDto, EventRequestRequestBuildDto, EventRequestResponseBuildDto>, IEventRequestShareRepository
    {
        ...
        /// </summary>
        public override Task<IEnumerable<EventRequestResponseShareDto>> CreateRangeAsync(IEnumerable<EventRequestRequestShareDto> entities)
        {
            try
            {
        ...
        /// </summary>
        public override Task DeleteRangeAsync(Expression<Func<EventRequestResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<bool> ExistsAsync(Expression<Func<EventRequestResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<EventRequestResponseShareDto?> FindAsync(Expression<Func<EventRequestResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<IEnumerable<EventRequestResponseShareDto>> GetAllAsync()
        {
            try
            {
        ...
        /// </summary>
        public override Task<EventRequestResponseShareDto?> GetByIdAsync(string id)
        {
            try
            {
        ...
        /// </summary>
        public override Task<EventRequestResponseShareDto> UpdateAsync(EventRequestRequestShareDto entity)
        {
            try
            {
