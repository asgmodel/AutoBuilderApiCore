    ...
    public class LanguageShareRepository : BaseShareRepository<LanguageRequestShareDto, LanguageResponseShareDto, LanguageRequestBuildDto, LanguageResponseBuildDto>, ILanguageShareRepository
    {
        ...
        public override async Task<LanguageResponseShareDto> CreateAsync(LanguageRequestShareDto entity)
        {
            try
            {
                ...
                var output = (LanguageResponseShareDto)result;
        ...
        /// </summary>
        public override Task<IEnumerable<LanguageResponseShareDto>> CreateRangeAsync(IEnumerable<LanguageRequestShareDto> entities)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult<IEnumerable<LanguageResponseShareDto>>(null);
            }
        }
        ...
        /// </summary>
        public override Task DeleteRangeAsync(Expression<Func<LanguageResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<bool> ExistsAsync(Expression<Func<LanguageResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<LanguageResponseShareDto?> FindAsync(Expression<Func<LanguageResponseShareDto, bool>> predicate)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult<LanguageResponseShareDto>(null);
            }
        }
        ...
        /// </summary>
        public override Task<IEnumerable<LanguageResponseShareDto>> GetAllAsync()
        {
            try
            {
        ...
        /// </summary>
        public override Task<LanguageResponseShareDto?> GetByIdAsync(string id)
        {
            try
            {
        ...
        /// </summary>
        public override Task<LanguageResponseShareDto> UpdateAsync(LanguageRequestShareDto entity)
        {
            try
            {
