...
namespace ApiCore.Repositorys.Share
{
    ...
    public class PlanFeatureShareRepository : BaseShareRepository<PlanFeatureRequestShareDto, PlanFeatureResponseShareDto, PlanFeatureRequestBuildDto, PlanFeatureResponseBuildDto>, IPlanFeatureShareRepository
    {
        ...
        /// </summary>
        public override Task<IEnumerable<PlanFeatureResponseShareDto>> CreateRangeAsync(IEnumerable<PlanFeatureRequestShareDto> entities)
        {
            try
            {
        ...
        /// </summary>
        public override Task DeleteRangeAsync(Expression<Func<PlanFeatureResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<bool> ExistsAsync(Expression<Func<PlanFeatureResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<PlanFeatureResponseShareDto?> FindAsync(Expression<Func<PlanFeatureResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<IEnumerable<PlanFeatureResponseShareDto>> GetAllAsync()
        {
            try
            {
        ...
        /// </summary>
        public override Task<PlanFeatureResponseShareDto?> GetByIdAsync(string id)
        {
            try
            {
        ...
        /// </summary>
        public override Task<PlanFeatureResponseShareDto> UpdateAsync(PlanFeatureRequestShareDto entity)
        {
            try
            {
