...
namespace ApiCore.Repositorys.Share
{
    ...
    /// </summary>
     public  PaymentShareRepository ( DataContext  dbContext ,  IMapper  mapper ,  ILoggerFactory  logger ) :  base ( mapper ,  logger ) // Pass parameters to the base class.
    ...
    /// </summary>
     public  async  Task < PaymentResponseShareDto > CreateAsync ( PaymentRequestShareDto  entity ) //
    { // Call the create method in the builder repository.
    //
    var  result  =  await  _builder . CreateAsync ( entity ) ;  // Convert the result to ResponseShareDto type.
    //
    var  output  =  ( PaymentResponseShareDto ) result ;  // Return the final result.
    //
    return  output ;  //
    } //
    /// <summary>
    ...
    /// </summary>
     public  Task  DeleteRangeAsync ( Expression < Func < PaymentResponseShareDto ,  bool > > predicate ) { //
    throw  new  NotImplementedException ( ) ;  //
    } //
    /// <summary>
    /// Method to check if an entity exists based on a condition.
    /// </summary>
     public  Task < bool > ExistsAsync ( Expression < Func < PaymentResponseShareDto ,  bool > > predicate ) { //
    throw  new  NotImplementedException ( ) ;  //
    } //
    /// <summary>
    /// Method to find an entity based on a condition.
    /// </summary>
     public  Task < PaymentResponseShareDto ? > FindAsync ( Expression < Func < PaymentResponseShareDto ,  bool > > predicate ) { //
    throw  new  NotImplementedException ( ) ;  //
    } //
    /// <summary>
    /// Method to retrieve all entities.
    /// </summary>
     public  Task < IEnumerable < PaymentResponseShareDto > > GetAllAsync ( ) { //
    throw  new  NotImplementedException ( ) ;  //
    } //
    /// <summary>
    ...
    /// </summary>
     public  IQueryable < PaymentResponseShareDto > GetQueryable ( ) { //
    throw  new  NotImplementedException ( ) ;  //
    } //
    /// <summary>
    ...
    /// </summary>
     public  Task < PaymentResponseShareDto > UpdateAsync ( PaymentRequestShareDto  entity ) { //
    throw  new  NotImplementedException ( ) ;  //
    } //
    }
