    ...
    public class AdvertisementTabShareRepository : BaseShareRepository<AdvertisementTabRequestShareDto, AdvertisementTabResponseShareDto, AdvertisementTabRequestBuildDto, AdvertisementTabResponseBuildDto>, IAdvertisementTabShareRepository
    {
        ...
        public override async Task<AdvertisementTabResponseShareDto> CreateAsync(AdvertisementTabRequestShareDto entity)
        {
            try
            {
                ...
                var output = (AdvertisementTabResponseShareDto)result;
        ...
        /// </summary>
        public override Task<IEnumerable<AdvertisementTabResponseShareDto>> CreateRangeAsync(IEnumerable<AdvertisementTabRequestShareDto> entities)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult<IEnumerable<AdvertisementTabResponseShareDto>>(null);
            }
        }
        ...
        /// </summary>
        public override Task DeleteRangeAsync(Expression<Func<AdvertisementTabResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<bool> ExistsAsync(Expression<Func<AdvertisementTabResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<AdvertisementTabResponseShareDto?> FindAsync(Expression<Func<AdvertisementTabResponseShareDto, bool>> predicate)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult<AdvertisementTabResponseShareDto>(null);
            }
        }
        ...
        /// </summary>
        public override Task<IEnumerable<AdvertisementTabResponseShareDto>> GetAllAsync()
        {
            try
            {
        ...
        /// </summary>
        public override Task<AdvertisementTabResponseShareDto?> GetByIdAsync(string id)
        {
            try
            {
        ...
        /// </summary>
        public override Task<AdvertisementTabResponseShareDto> UpdateAsync(AdvertisementTabRequestShareDto entity)
        {
            try
            {
