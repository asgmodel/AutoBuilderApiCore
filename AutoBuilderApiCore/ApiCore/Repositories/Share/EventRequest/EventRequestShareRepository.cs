    ...
    public class EventRequestShareRepository : BaseShareRepository<EventRequestRequestShareDto, EventRequestResponseShareDto, EventRequestRequestBuildDto, EventRequestResponseBuildDto>, IEventRequestShareRepository
    {
        ...
        public async Task<EventRequestResponseShareDto> CreateAsync(EventRequestRequestShareDto entity)
        {
            try
            {
                ...
                var output = (EventRequestResponseShareDto)result;
        ...
        public Task<IEnumerable<EventRequestResponseShareDto>> CreateRangeAsync(IEnumerable<EventRequestRequestShareDto> entities)
        {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult<IEnumerable<EventRequestResponseShareDto>>(null);
            }
        }
        ...
        public Task<EventRequestResponseShareDto?> FindAsync(Expression<Func<EventRequestResponseShareDto, bool>> predicate)
        {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult<EventRequestResponseShareDto>(null);
            }
        }
