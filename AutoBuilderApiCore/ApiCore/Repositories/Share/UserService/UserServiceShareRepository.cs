...
namespace ApiCore.Repositorys.Share
{
    ...
    public class UserServiceShareRepository : BaseShareRepository<UserServiceRequestShareDto, UserServiceResponseShareDto, UserServiceRequestBuildDto, UserServiceResponseBuildDto>, IUserServiceShareRepository
    {
        ...
        /// </summary>
        public override Task<IEnumerable<UserServiceResponseShareDto>> CreateRangeAsync(IEnumerable<UserServiceRequestShareDto> entities)
        {
            try
            {
        ...
        /// </summary>
        public override Task DeleteRangeAsync(Expression<Func<UserServiceResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<bool> ExistsAsync(Expression<Func<UserServiceResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<UserServiceResponseShareDto?> FindAsync(Expression<Func<UserServiceResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<IEnumerable<UserServiceResponseShareDto>> GetAllAsync()
        {
            try
            {
        ...
        /// </summary>
        public override Task<UserServiceResponseShareDto?> GetByIdAsync(string id)
        {
            try
            {
        ...
        /// </summary>
        public override Task<UserServiceResponseShareDto> UpdateAsync(UserServiceRequestShareDto entity)
        {
            try
            {
