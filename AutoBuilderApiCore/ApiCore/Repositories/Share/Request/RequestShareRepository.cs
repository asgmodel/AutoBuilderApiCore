...
namespace ApiCore.Repositorys.Share
{
    ...
    public class RequestShareRepository : BaseShareRepository<RequestRequestShareDto, RequestResponseShareDto, RequestRequestBuildDto, RequestResponseBuildDto>, IRequestShareRepository
    {
        ...
        /// </summary>
        public override Task<IEnumerable<RequestResponseShareDto>> CreateRangeAsync(IEnumerable<RequestRequestShareDto> entities)
        {
            try
            {
        ...
        /// </summary>
        public override Task DeleteRangeAsync(Expression<Func<RequestResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<bool> ExistsAsync(Expression<Func<RequestResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<RequestResponseShareDto?> FindAsync(Expression<Func<RequestResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<IEnumerable<RequestResponseShareDto>> GetAllAsync()
        {
            try
            {
        ...
        /// </summary>
        public override Task<RequestResponseShareDto?> GetByIdAsync(string id)
        {
            try
            {
        ...
        /// </summary>
        public override Task<RequestResponseShareDto> UpdateAsync(RequestRequestShareDto entity)
        {
            try
            {
