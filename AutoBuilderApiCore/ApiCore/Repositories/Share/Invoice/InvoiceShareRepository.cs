    ...
    public class InvoiceShareRepository : BaseShareRepository<InvoiceRequestShareDto, InvoiceResponseShareDto, InvoiceRequestBuildDto, InvoiceResponseBuildDto>, IInvoiceShareRepository
    {
        ...
        public override async Task<InvoiceResponseShareDto> CreateAsync(InvoiceRequestShareDto entity)
        {
            try
            {
                ...
                var output = (InvoiceResponseShareDto)result;
        ...
        /// </summary>
        public override Task<IEnumerable<InvoiceResponseShareDto>> CreateRangeAsync(IEnumerable<InvoiceRequestShareDto> entities)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult<IEnumerable<InvoiceResponseShareDto>>(null);
            }
        }
        ...
        /// </summary>
        public override Task DeleteRangeAsync(Expression<Func<InvoiceResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<bool> ExistsAsync(Expression<Func<InvoiceResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<InvoiceResponseShareDto?> FindAsync(Expression<Func<InvoiceResponseShareDto, bool>> predicate)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult<InvoiceResponseShareDto>(null);
            }
        }
        ...
        /// </summary>
        public override Task<IEnumerable<InvoiceResponseShareDto>> GetAllAsync()
        {
            try
            {
        ...
        /// </summary>
        public override Task<InvoiceResponseShareDto?> GetByIdAsync(string id)
        {
            try
            {
        ...
        /// </summary>
        public override Task<InvoiceResponseShareDto> UpdateAsync(InvoiceRequestShareDto entity)
        {
            try
            {
