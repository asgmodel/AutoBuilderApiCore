...
namespace ApiCore.Repositorys.Share
{
    ...
    public class ModelGatewayShareRepository : BaseShareRepository<ModelGatewayRequestShareDto, ModelGatewayResponseShareDto, ModelGatewayRequestBuildDto, ModelGatewayResponseBuildDto>, IModelGatewayShareRepository
    {
        ...
        /// </summary>
        public override Task<IEnumerable<ModelGatewayResponseShareDto>> CreateRangeAsync(IEnumerable<ModelGatewayRequestShareDto> entities)
        {
            try
            {
        ...
        /// </summary>
        public override Task DeleteRangeAsync(Expression<Func<ModelGatewayResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<bool> ExistsAsync(Expression<Func<ModelGatewayResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<ModelGatewayResponseShareDto?> FindAsync(Expression<Func<ModelGatewayResponseShareDto, bool>> predicate)
        {
            try
            {
        ...
        /// </summary>
        public override Task<IEnumerable<ModelGatewayResponseShareDto>> GetAllAsync()
        {
            try
            {
        ...
        /// </summary>
        public override Task<ModelGatewayResponseShareDto?> GetByIdAsync(string id)
        {
            try
            {
        ...
        /// </summary>
        public override Task<ModelGatewayResponseShareDto> UpdateAsync(ModelGatewayRequestShareDto entity)
        {
            try
            {
